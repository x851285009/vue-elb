          ...
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span class="delivery">{{rating.deliveryTime ? rating.deliveryTime + '分钟' : ''}}</span>
              </div>
              <p class="text">{{rating.text}}</p>
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0 ? 'icon-tuijian' : 'icon-thumbdown'"></span>
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            line-height: 16px
            font-size: 0
            .icon-tuijian, .icon-thumbdown, .item
              display: inline-block
              margin: 0 8px 4px 0
              font-size: 9px
            .icon-tuijian
